            ...
            <%/foreach%>
                ...
                <!--<div class="form-row row-fluid" id="cc_sh_dpm_unique_id" >
                    ...
                    <%else%>
                        ...
                        <span><a style="text-decoration: none;" class="tipR" hijacked="yes" title="Clave de proveedor personalizado debe ser único para identificar los proveedores personalizados" ><span class="icomoon-icon-help"></span></a></span>
                    <%/if%>
                    <%/foreach%>                                                                        
                    </div>
                ...
                <div class="form-row row-fluid" id="cc_sh_dpm_seq_no">
                    ...
                    <div class="form-right-div span8">
                        <input type="text" placeholder="Escriba el orden de visualización" value="<%$item['iSeqNo']%>" style="width: 49% !important;" name="dpm_seq_no" id="dpm_seq_no" title="Orden de visualización" class="frm-size-medium" required>
                    </div>
...
<script>
    $("#dpm_provider_profit").on('change', function () {
        if(parseInt($(this).val()) < 35){
            alert("¡La utilidad mínima es de 35%!");
            $(this).val("35.00");
        } else {
...
function processForm( e ){
    ...
    function(){
            $('#Alert').append("<div class='alert alert-success' id='success-alert'><button type='button' class='close' data-dismiss='alert'>x</button>¡Datos del Proveedor actualizados!</div>");
